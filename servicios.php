...
$sql = $con->prepare("SELECT idProducto, TipoProducto, Monto FROM servicio WHERE Activo=1");
$sql->execute();
    ...
    <?php foreach($resultado as $row) { ?>
        <div class="col">
          <div class="card shadow-sm">
            ...
            $id = $row['idProducto'];
            $imagen = "imagenes/servicios/" . $id . "/principal.jpg";
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="detalleServ.php?idProducto=<?php echo $row['idProducto']; ?>&token=<?php echo
                ...
                echo $row['idProducto']; ?>, '<?php echo hash_hmac('sha1', $row['idProducto'], KEY_TOKEN); ?>')">Agendar Servicio</button>
              </div>
            </div>
          </div>
        </div>
